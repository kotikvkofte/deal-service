...
class DealControllerTest {
    ...
    void testSave_updateDeal_success() throws Exception {
        ...
        DealSaveRequestDto request = DealSaveRequestDto.builder()
                .id("c9ddcc2a-d927-4904-89a0-7e666aae1644")
        ...
        UUID dealId = UUID.fromString(request.getId());
    ...
    void testChangeStatus_success() throws Exception {
        DealChangeStatusDto request = new DealChangeStatusDto("11111111-2222-3333-4444-555555555555", "APPROVED");
